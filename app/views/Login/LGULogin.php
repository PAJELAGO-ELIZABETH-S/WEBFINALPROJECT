      ...
      <div class="col-md-8 col-lg-7 col-xl-6">
        <div class="card" >
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item text-center"> <a class="nav-link btr active" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="true">Signin</a> </li>
            </ul>
                ...
                <div class="row mb-4">
                    <div class="form px-4">
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <button type="submit" href="/Main"class="btn btn-dark btn-block">Signin</button>
                            <a href="<?=site_url()?>/LGURegister">Create Account?</a>
                        </form>
                       </div>
                    </div>
                </div>
