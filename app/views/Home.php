...
<div class="hero_area">
      <div class="hero_bg_box">
           <img src="public/agrisync/images/BG.png" alt="">
    ...
    <div class="container ">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="box ">
            <div class="img-box">
              <img src="public/agrisync/images/livestock.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Livestock Program
        ...
        <div class="col-md-3">
          <div class="box ">
            <div class="img-box">
              <img src="public/agrisync/images/organic.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
        ...
        <div class="col-md-3">
          <div class="box ">
            <div class="img-box">
              <img src="public/agrisync/images/saad.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
        ...
        <div class="col-md-3">
          <div class="box ">
            <div class="img-box">
              <img src="public/agrisync/images/hvcd.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
...
<section class="doctor_section layout_padding">
      <div class="container">
        ...
        <div class="col-sm-6 col-lg-4 mx-auto">
            <div class="box">
              <div class="img-box">
                <img src="public/agrisync/images/oc.png" alt="" height="600" width="90">
              </div>
              <div class="detail-box">
                <h5>
                   Occidental Mindoro
        ...
        <div class="col-sm-6 col-lg-4 mx-auto">
          ...
          <div class="col-sm-6 col-lg-4 mx-auto">
            <div class="box">
              <div class="img-box">
                <img src="public/agrisync/images/or.png" alt="" height="600" width="90">
              <div class="detail-box">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-lg-4 mx-auto">
            <div class="box">
              <div class="img-box">
                <img src="public/agrisync/images/d5.jpg" alt="">
              </div>
              <div class="detail-box">
          ...
          <div class="col-sm-6 col-lg-4 mx-auto">
            <div class="box">
              <div class="img-box">
                <img src="public/agrisync/images/d2.jpg" alt="">
              </div>
              <div class="detail-box">
                <div class="social_box">
          ...
          <div class="col-sm-6 col-lg-4 mx-auto">
            <div class="box">
              <div class="img-box">
                <img src="public/agrisync/images/d4.jpg" alt="">
              </div>
              <div class="detail-box">
                <div class="social_box">
          ...
          <div class="col-sm-6 col-lg-4 mx-auto">
            <div class="box">
              <div class="img-box">
                ...
                <img src="public/agrisync/images/d3.jpg" alt="">
              </div>
              <div class="detail-box">
                <div class="social_box">
